...
See https://docs.spring.io/spring-integration/docs/5.0.9.RELEASE/reference/html/java-dsl.html#java-dsl-gateway[java-dsl-gateway] in the Java DSL chapter for options to define gateways through `IntegrationFlows`.
